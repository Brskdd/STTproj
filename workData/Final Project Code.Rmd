...
```
```{r null dist boxplot}
boxplot(nullDist, main = "null dist between M and F decisions", xlab = "observed mean diff M - F (= .0688, red)", horizontal = TRUE)
...
```{r histogram for men}
hist(nulldistM,
     main = "Null Dist of Correlations Between M-F Age Gaps and Perceived Attractiveness",
     xlab = paste("Test Correlation =", CorM, "(red)"),
     col = "lightgray",
     border = "black")
...
hist(nulldistF,
     main = "Null Dist of Correlations Between F-M Age Gaps and Perceived Attractiveness",
     xlab = paste("Test Correlation =", CorF, "(red)"),
     col = "lightgray",
     border = "black")
