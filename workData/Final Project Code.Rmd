...
hist(nulldistM, main = "Null Dist of How Men Rate Women as Attractive vs Fun", xlim = c(-.25, .65), xlab = "Test Correlation")
abline(v = CorM, col = "red")
text(x = 0.3, y = 200, labels = paste("Observed CorM = ", round(CorM, 4)), pos = 3, col = "red")
...
hist(nulldistF, main = "Null Dist of How Women Percieve Men as Attractive vs Fun", xlim = c(-0.25, 0.6))
text(x = 0.4, y = 200, labels = paste("Observed CorF = ", round(CorF, 4)), pos = 3, col = "red")
abline(v=CorF, col = "red")
