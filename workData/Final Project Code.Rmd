...
```{r null dist boxplot}
 #diff M - F (= .0688, red)"
png("Q1_hist.png", width = 800, height = 600, res = 100)

hist(nullDist, 
        main = expression(paste("Null Distribution of Saying Yes between Men and Women (" , pi[M], " - ", pi[F], ")")),
...
```
```{r histogram for men}
png("Q3_M_hist.png", width = 800, height = 600, res = 100)
...
png("Q3_hist_F.png", width = 800, height = 600, res = 100)
...
#png("Q4_scatter_M.png", width = 800, height = 600, res = 100)
...
png("Q4_hist_M.png", width = 800, height = 600, res = 100)

hist(nulldistM, main = "Null Dist of How Men Rate Women as Attractive vs Fun", ylim = c(-.25, .25), xlab = "Test Correlation")
abline(v = CorM, col = "red")
...
#png("Q4_scatter_F.png", width = 800, height = 600, res = 100)
...
png("Q4_hist_F.png", width = 800, height = 600, res = 100)


hist(nulldistF, main = "Null Dist of How Women Percieve Men as Attractive vs Fun", ylim = c(-.25, .25), xlab = "Test Correlation")
abline(v = CorF, col = "red")
